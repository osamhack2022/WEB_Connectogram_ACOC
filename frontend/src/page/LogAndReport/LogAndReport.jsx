    ...
    return (
        <div style={{backgroundColor: 'transparent', height: '88vh' , display: 'flex', flexDirection: 'row' }}>
            ...
            <div style={{width: '50%', height: '100%', backgroundColor: 'transparent', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column'}}>
                <div style={{ width: '100%'}}>
                <div style={{ height: '32px', backgroundColor: 'black', color: 'white', fontFamily: 'Noto Sans KR', paddingLeft: '8px', display: 'flex', alignItems: 'center'}}>프로토콜별 연결 수</div>
                ...
                <div style={{ width: '100%', height: '45vh', backgroundColor: 'yellow', border: '1px solid black'}}></div>
            </div>
            <div style={{paddingRight: '32px', paddingLeft: '32px', width: '25%', height: '100%', backgroundColor: 'transparent', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column'}}>
                <div style={{ width: '25vw', height: '40vh', border: '1px solid black'}}>
                    ...
                    { !PieFlag ? <div>로딩 중...</div> : <ResponsivePie
                        data={CountryData}   
                ...
                <div style={{ width: '25vw', height: '40vh', backgroundColor: 'green', border: '1px solid black'}}></div>
            </div>
        </div>
    );
}
