        ...
        <div>
            ...
            <div style={{display: 'flex', flexDirection: 'row'}}>
                <div style={{ width: '75vw'}}>
                    <div style={{width: '75vw', height: '8vh', backgroundColor: 'transparent', display: 'flex', alignItems: 'end', position: 'relative' }}> 
                    ...
                    <div style={{width: '75vw', height: '5vh', backgroundColor: 'transparent', position: 'relative'}}>
                    ...
                    { isLoading ? <div style={{height: '78vh', width: '75vw', backgroundColor: 'transparent', textAlign: 'center', fontFamily: 'Noto Sans KR', fontSize: 40, paddingTop: 56}}>로딩 중...</div> : 
                    <div style={{height: '78vh', backgroundColor: 'transparent', paddingRight: '80px', paddingLeft: '40px', gridTemplateColumns: "1fr 1fr 1fr 1fr 1fr 1fr 1fr 1fr", zIndex: 1, display: 'grid', gridAutoFlow: 'row', gridAutoRows: '9vw' }}>
                ...
                <div style={{width: '25vw', display: 'flex', alignItems: 'center'}}>
                    <div style={{ width: '25vw'}}>
                        ...
                        <div style={{ height: '87vh', backgroundColor: 'transparent', border: '1px solid black' }}>
                            ...
                            <div style={{width: '100%', borderTop: '1px solid black', fontFamily: 'Noto Sans KR'}}>
